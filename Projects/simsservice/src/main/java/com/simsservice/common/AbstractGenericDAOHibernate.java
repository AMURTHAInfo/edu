/**
 * @ (#) AbstractGenericDAOHibernate.java
 * Project     : SIMS
 * File        : AbstractGenericDAOHibernate.java
 * Author      : Ninganna C
 * Company     : 
...
public class AbstractGenericDAOHibernate<T, ID extends Serializable> implements GenericDao<T, ID> {
	 ...
	 */
	public Session getSession() throws SimsException {
		if (session == null) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public T findById(Integer integer) throws SimsException {
		T entity = null;
		try {
			entity = (T) getSession().get(getPersistentClass(), integer);
		} catch (JDBCException he) {
			LOGGER.error("Error in saveOrUpdate", he);
			throw new SimsException(he.getMessage(), he.getErrorCode(), he);
		} catch (HibernateException he) {
			LOGGER.error("Error in saveOrUpdate", he);
			throw new SimsException(he.getMessage(), he);
		}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<T> findByExample(T exampleInstance, String... excludeProperty) throws SimsException {
		Criteria crit = null;
		try {
	 ...
	 *             .
	 */
	public T saveOrUpdate(T entity) throws SimsException {
		try {
	 ...
	 *             .
	 */
	public T save(T entity) throws SimsException {
		try {
	...
	public void delete(T entity) throws SimsException {
		try {
	 ...
	 *             .
	 */
	public void flush() throws SimsException {
		try {
			getSession().flush();
		} catch (JDBCException he) {
	 ...
	 *             .
	 */
	public void clear() throws SimsException {
		try {
			getSession().clear();
		} catch (JDBCException he) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<T> findByCriteria(Criterion... criterion) throws SimsException {
		Criteria crit = null;
		try {
			crit = getSession().createCriteria(getPersistentClass());
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<T> fetchPage(int firstRec, int maxRec, String sortColumn, String orderType,
	 ...
	 */
	// @SuppressWarnings("unchecked")
	public Integer getSize(Map<String, String> criterionAliasMap, Criterion... criterion) throws SimsException {
		Criteria crit = null;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public T findByUniqueCriteria(Criterion... criterion) throws SimsException {
		Criteria crit = null;
		try {
			crit = getSession().createCriteria(getPersistentClass());
			for (Criterion c : criterion) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List findByQuery(String hql) throws SimsException {
		Query query = null;
		try {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Object findById(Integer entityId, Class clazz) throws SimsException {
		Object entity = null;
		try {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<T> findByQuery(String hql, Integer parameter) throws SimsException {
		Query query = null;
		try {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List findByQuery(String hql, String parameter) throws SimsException {
		Query query = null;
		try {
			query = getSession().createQuery(Utility.hqlToken(hql));
			query.setParameter("1", parameter);
	...
	@SuppressWarnings("unchecked")
	public Object findByQueryString(String hql, String parameter) throws SimsException {
		Query query = null;
		try {
			query = getSession().createQuery(Utility.hqlToken(hql));
			query.setParameter("1", parameter);
	 ...
	 * @throws SimsException
	 */
	public List findByQuery(String[] strQuery, List arlParams) throws SimsException {
		...
		try {
			...
			do {
				...
				if (iInindex > 0) {
					...
					if (strQueryupAfterIN.substring(strQueryupAfterIN.indexOf("("), strQueryupAfterIN.indexOf(")"))
			...
			Query query = getSession()
					.createQuery(Utility.hqlToken(Utility.replaceString(strFinalQuery, "|IN|", " IN ")));
			...
			LOGGER.error("Error in findByQuery", he);
			throw new SimsException(he.getMessage(), 100, he);
		}
		return recordList;
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List findByQueryParams(String hql, Object... params) throws SimsException {
		Query query = null;
		try {
			query = getSession().createQuery(Utility.hqlToken(hql));
			int iparaIndex = 1;
	 ...
	 *             .
	 */
	public void updateOrDeleteQuery(String hql, Object... params) throws SimsException {
		Query query = null;
		try {
			query = getSession().createQuery(Utility.hqlToken(hql));
			int iparaIndex = 1;
	...
	/**
	 * This method only for my transaction DAO This method takes hql query and
	 * query parameters as arguments and executes the query . Applicable for
	 * Edit or Delete
	 * 
	 * @param hql
	 * @param params
	 ...
	 *             .
	 */
	public int updateOrDeleteQueryTransaction(String hql, Object... params) throws SimsException {
		Query query = null;
		int ct = 0;
		try {
			query = getSession().createQuery(Utility.hqlToken(hql));
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<T> findByCriteria(String orderByPropertyNames, Criterion... criterion) throws SimsException {
		Criteria crit = null;
		try {
			crit = getSession().createCriteria(getPersistentClass());
			for (Criterion c : criterion) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<T> findByCriteria(String orderByPropertyNames, String orderType, Map<String, String> criterionAliasMap,
			Criterion... criterion) throws SimsException {
		Criteria crit = null;
		try {
			crit = getSession().createCriteria(getPersistentClass());
			for (Criterion c : criterion) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List findAll(Class clazz) throws SimsException {
		List<Object> objList;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List findByCriteria(Class clazz, Criterion... criterion) throws SimsException {
		Criteria crit = null;
		try {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Object saveOrUpdate(Class clazz, Object obj) throws SimsException {
		try {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<T> findByCriteria(Map<String, String> aliasMap, Criterion... criterion) throws SimsException {
		Criteria crit = null;
		try {
			crit = getSession().createCriteria(getPersistentClass());
			for (Criterion c : criterion) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Integer getSize(Class clazz, Map<String, String> criterionAliasMap, Criterion... criterion)
			throws SimsException {
		Criteria crit = null;
		Integer itemCount = null;
		try {
